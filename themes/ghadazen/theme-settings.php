 ...
 */
function ghadazen_form_system_theme_settings_alter(&$form, &$form_state, $form_id = NULL) {
  ...
  $form['ghadazen_example'] = array(
  '#type'          => 'checkbox',
  '#title'         => t('ghadazen sample setting'),
  '#default_value' => theme_get_setting('ghadazen_example'),
